...
public class HeatDissipationEnchantment extends Enchantment {

    public HeatDissipationEnchantment() {
    ...
    public static void registerEnchantment(ScorchingSun plugin) {
        ...
        if (Enchantment.getByKey(NamespacedKey.minecraft(getEchName())) == null) {
            Enchantment.registerEnchantment(new HeatDissipationEnchantment());
        }
    }
}
